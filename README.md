...
The default image is minimal and includes `cc-connect` plus Codex CLI. See [docs/docker-compose.md](docs/docker-compose.md) for volume layout, host UID/GID mapping, config paths, webhook ports, and derived-image examples when you need extra tools such as `ffmpeg` or other agent CLIs.
